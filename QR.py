...
VERSION = '2.1.0'
PLACEMENT_OPTIONS = [
    {'name': 'Left Up A4', 'dimension': 70, 'width': 0, 'height': 772},
    {'name': 'Left Down A4', 'dimension': 70, 'width': 0, 'height': 0},
    {'name': 'Right Up A4', 'dimension': 65, 'width': 528, 'height': 741},
    {'name': 'Right Down A4', 'dimension': 65, 'width': 528, 'height': 0},
    {'name': 'Right Up Letter', 'dimension': 70, 'width': 525, 'height': 772},

]
UTM_OPTIONS = [
    {'name': 'None', 'utm_link': ''},
    {'name': 'Free', 'utm_link': '?utm_source=alaatv&utm_medium=qrCode&utm_campaign=pdf&utm_term=free'},
    ...
    {'name': 'Titan', 'utm_link': '?utm_source=alaatv&utm_medium=qrCode&utm_campaign=pdf&utm_term=titan'},
    {'name': 'Godar', 'utm_link': '?utm_source=alaatv&utm_medium=qrCode&utm_campaign=pdf&utm_term=godar'},
...
if __name__ == '__main__':
    ...
    if DEBUG or (len(sys.argv) > 1 and sys.argv[1] == 'updated'):
        ...
        if pdf_on:
            pdf()
        input("Press ENETER key to exit . . .")
    else:
